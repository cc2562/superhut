                ...
                child: EnhancedFutureBuilder(
                  ...
                  whenDone: (v) {
                    ...
                    if (_searchText.isNotEmpty) {
                      List<Map<String, dynamic>> filteredServices = allServicesWithCategory
                          .where((item) => 
                              item['service'].serviceName.toLowerCase().contains(_searchText.toLowerCase()) ||
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          FunctionItem service = filteredServices[index]['service'];
                          ...
                          return Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (index == 0 || filteredServices[index]['category'] != filteredServices[index - 1]['category'])
                                  Padding(
