...
class _FunctionDrinkPageState extends State<FunctionDrinkPage> {
                ...
                return AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      stops: logic.state.drinkStatus.value 
  ...
  Widget waterStatusWidget() {
    return GetBuilder<FunctionDrinkLogic>(builder: (logic) {
      return Container(
  ...
  Widget deviceDrinkRowBtnWidget() {
    return Padding(
      ...
      child: GetBuilder<FunctionDrinkLogic>(builder: (logic) {
        // 如果没有设备或未选择设备
        if (logic.state.deviceList.isEmpty || logic.state.choiceDevice.value == -1) {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          trailing: logic.state.choiceDevice.value == index
                              ? Icon(Ionicons.checkmark_circle, color: Theme.of(context).primaryColor)
                              : null,
                          onTap: () {
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              ListTile(
                leading: Icon(Ionicons.add_circle_outline, color: Colors.blue),
                title: Text('添加设备'),
                onTap: () {
                        ...
                        return Padding(
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text('ID: ${logic.state.deviceList[i]["id"]}'),
                              trailing: IconButton(
                                icon: Icon(Ionicons.remove_circle_outline, color: Colors.red),
                                onPressed: () {
                                  showDialog(
                                    context: context,
                                    builder: (context) => AlertDialog(
                                      title: Text('确认删除'),
                                      content: Text('确定要删除设备"${logic.formatDeviceName(logic.state.deviceList[i]["name"])}"吗？'),
                                      actions: [
                                        TextButton(
                                          onPressed: () {
                                            Navigator.pop(context);
                                        ...
                                        TextButton(
                                          onPressed: () {
                                            logic.favoDevice(
                                                logic.state.deviceList[i]["id"].toString(),
                                                true, context);
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Ionicons.information_circle_outline, color: Theme.of(context).colorScheme.primary, size: 24),
                          SizedBox(width: 10),
                          Expanded(
                            child: Text(
                              '扫描设备上的二维码，添加到您的设备列表',
                    ...
                    FilledButton.icon(
                      ...
                      label: Text('扫描设备二维码', style: TextStyle(fontSize: 16)),
                      style: ButtonStyle(
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Ionicons.information_circle_outline, color: Colors.blue),
                      SizedBox(width: 10),
                      Expanded(
                        child: Text(
                          '将二维码放入框内，即可自动扫描',
                ...
                Row(
                  ...
                  children: [
                    TextButton.icon(
                      ...
                      icon: Icon(
                        _isFlashOn ? Ionicons.flashlight : Ionicons.flashlight_outline,
                        color: Colors.white,
                        size: 24,
                      ),
                      label: Text(
